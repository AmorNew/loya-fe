...
goog.exportSymbol('proto.position.PositionReq', null, global);
/**
 ...
 * @constructor
 */
proto.position.PositionReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.position.PositionReq.repeatedFields_, null);
};
goog.inherits(proto.position.PositionReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.position.PositionReq.displayName = 'proto.position.PositionReq';
}
 ...
 * @const
 */
proto.position.PositionReq.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.position.PositionReq.prototype.toObject = function(opt_includeInstance) {
  return proto.position.PositionReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.position.PositionReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.position.PositionReq.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.position.PositionReq}
 */
proto.position.PositionReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.position.PositionReq;
  return proto.position.PositionReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.position.PositionReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.position.PositionReq}
 */
proto.position.PositionReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.position.PositionReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.position.PositionReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.position.PositionReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.position.PositionReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<string>}
 */
proto.position.PositionReq.prototype.getUnitIdsList = function() {
 ...
 * @return {!proto.position.PositionReq} returns this
 */
proto.position.PositionReq.prototype.setUnitIdsList = function(value) {
 ...
 * @return {!proto.position.PositionReq} returns this
 */
proto.position.PositionReq.prototype.addUnitIds = function(value, opt_index) {
 ...
 * @return {!proto.position.PositionReq} returns this
 */
proto.position.PositionReq.prototype.clearUnitIdsList = function() {
